...
export default function Map({
  ...
  return (
    <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-inner border border-slate-200 dark:border-slate-800/50 bg-slate-100 dark:bg-slate-950 map-grid">
      ...
      {/* Map legend */}
      <div className="absolute top-4 right-4 z-20 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-3 py-2 rounded-xl shadow-lg border border-slate-100 dark:border-slate-800 text-[11px] font-medium space-y-1.5 text-slate-700 dark:text-slate-300 pointer-events-auto">
        <div className="font-semibold text-slate-900 dark:text-slate-100 mb-1">車輛剩餘狀態</div>
